...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <article className="flex h-full flex-col rounded-2xl border border-line bg-canvas/60 p-5 transition duration-300 hover:border-accent/25 hover:bg-surface sm:p-6">
